...
### Current builds
- **[Requirements-extraction assistant](https://github.com/saiganeshm093/requirements-extraction-assistant)** — meeting transcripts to structured user stories, acceptance criteria, and action registers; Node.js + Claude API, with ground-truth evaluation and documented hallucination controls
